						...
						<div class="col-md-10">
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a
									href="DeleteEvent.jsp">Delete Event<span class="sr-only">(current)</span></a></li>
							</ul>
						</div>
						<div class="col-md-1">
							<ul class="nav nav-pills">
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<label class="panel-title"><a href="ViewEvent.jsp"><%=event.getEventName()%></a></label>
			</div>
			<div class="panel-body">
				<div class="container-fluid">
					...
					<div class="form-group">
						<label>Event Address:<%=event.getEventAddress()%></label>
					</div>
					<div class="form-group">
						<label>Posted By: <%=userService.getuserName(event.getAdminId())%></label>
					</div>
					<hr />
					<a href="delete.jsp?id=<%=event.getId()%>"><b>DELETE</b><i
