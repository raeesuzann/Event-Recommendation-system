...
<body>
						...
						<div class="col-md-10">
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a
									href="ViewDetails.jsp">View Event<span class="sr-only">(current)</span></a></li>
							</ul>
						</div>
						<div class="col-md-1">
							<ul class="nav nav-pills">
	...
	<div class="container">
		...
		<%
			...
			String eventCat = (String)request.getAttribute("eventCategory");
			AdminService userService = new AdminServiceImpl();
			EventService eventService = new EventServiceImpl();
			List<Event> searchedevent = eventService.search(eventCat);
